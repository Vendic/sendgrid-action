...
const client = __nccwpck_require__(710);
const Client = __nccwpck_require__(7816);
...
const pkg = __nccwpck_require__(3690);
const {
  helpers: {
    mergeData,
  },
 ...
 * Dependencies
 */
const toCamelCase = __nccwpck_require__(2918);
const toSnakeCase = __nccwpck_require__(789);
const deepClone = __nccwpck_require__(7700);
 ...
 * Dependencies
 */
const splitNameEmail = __nccwpck_require__(4320);
 ...
 * Expose classes
 */
const Attachment = __nccwpck_require__(5613);
const EmailAddress = __nccwpck_require__(2806);
const Mail = __nccwpck_require__(9430);
const Personalization = __nccwpck_require__(1084);
const Response = __nccwpck_require__(2246);
const ResponseError = __nccwpck_require__(4112);
const Statistics = __nccwpck_require__(9109);
...
const toSnakeCase = __nccwpck_require__(789);
const deepClone = __nccwpck_require__(7700);
const arrayToJSON = __nccwpck_require__(8273);
const { DYNAMIC_TEMPLATE_CHAR_WARNING } = __nccwpck_require__(8144);
const {validateMailSettings, validateTrackingSettings} = __nccwpck_require__(4316);
...
const toSnakeCase = __nccwpck_require__(789);
const deepClone = __nccwpck_require__(7700);
const deepMerge = __nccwpck_require__(8260);
const wrapSubstitutions = __nccwpck_require__(1188);
 ...
 */
const arrayToJSON = __nccwpck_require__(8273);
const convertKeys = __nccwpck_require__(902);
const deepClone = __nccwpck_require__(7700);
const mergeData = __nccwpck_require__(6136);
const splitNameEmail = __nccwpck_require__(4320);
const toCamelCase = __nccwpck_require__(2918);
const toSnakeCase = __nccwpck_require__(789);
const wrapSubstitutions = __nccwpck_require__(1188);
 ...
 */
const convertKeys = __nccwpck_require__(902);
const strToCamelCase = __nccwpck_require__(5533);
 ...
 */
const convertKeys = __nccwpck_require__(902);
const strToSnakeCase = __nccwpck_require__(9206);
 ...
 * Load support assets
 */
const classes = __nccwpck_require__(3826);
const helpers = __nccwpck_require__(1445);
...
const mailer = __nccwpck_require__(1821);
const MailService = __nccwpck_require__(5147);
...
const {classes: {Mail}} = __nccwpck_require__(4201);
...
var createError = __nccwpck_require__(8379);
var enhanceError = __nccwpck_require__(1334);
var transitionalDefaults = __nccwpck_require__(277);
var Cancel = __nccwpck_require__(174);
...
axios.Cancel = __nccwpck_require__(174);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const run_1 = __importDefault(__nccwpck_require__(1224));
(0, run_1.default)();
...
async function run() {
    try {
        ...
        let dynamicData = {};
        await dynamicTemplateDataVariableNames.forEach((item) => {
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(3709);
